...
public class retropropagation {
    ...
    public void retropropagation(ArrayList<ArrayList<ArrayList<Double>>>liste,ArrayList<ArrayList<ArrayList<Double>>>listefxprecedante,ArrayList<ArrayList<ArrayList<Double>>>listefxsortie,ArrayList<ArrayList<ArrayList<Double>>> listexderive,ArrayList<ArrayList<ArrayList<Double>>> listeerreur,double tauxapp) throws LongueurException, Exception {
        ...
        for (int i = 0; i <taillelistesortie ; i++) {
            ...
            for (int j = 0; j <liste.get(i).size() ; j++) {
                ...
                double v = - calculeerreur.get(i).get(j).get(0) * listefxsortie.get(0).get(i).get(0) * listexderive.get(0).get(i).get(0) * listefxprecedante.get(i).get(j).get(0);
